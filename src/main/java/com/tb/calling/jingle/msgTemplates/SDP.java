...
public class SDP {
    ...
    public String createMessage(String serverIp, String apartyWithId, String bpartyWithId, String id) {
        ...
        String xmlPayload = String.format(
                """
                    <iq to="%s" from="%s" type="set" id="mvF6f66hnLkV">
                                   <jingle action="session-accept" sid="%S" xmlns="urn:xmpp:jingle:1">
                                     <content creator="initiator" name="0">
                                       ...
                                       <transport ufrag="UHHK" xmlns="urn:xmpp:jingle:transports:ice-udp:1" pwd="OlZzeiJbn2gZ7rvIjCufVzbE">
                                         <fingerprint xmlns="urn:xmpp:jingle:apps:dtls:0" hash="sha-256" setup="active">36:83:11:24:F7:72:3C:8F:FF:F8:7F:4E:52:01:94:6F:40:47:AB:FA:9D:C8:85:E1:AA:3C:CC:10:93:8F:3F:7A
                                                         										</fingerprint>
